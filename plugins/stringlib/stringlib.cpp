...
"  string StringFilter(const string src, const string _within) : c,pure,fold,entrypoint='slStringFilter'; \n"
"  string StringSubstituteOut(const string src, const string _within, const string _newchar) : c,pure,entrypoint='slStringSubsOut'; \n"
"  string StringSubstitute(const string src, const string _within, const string _newchar) : c,pure,fold,entrypoint='slStringSubs'; \n"
"  string StringRepad(const string src, unsigned4 size) : c,pure,fold,entrypoint='slStringRepad'; \n"
"  string StringTranslate(const string src, const string _within, const string _mapping) : c,pure,fold,entrypoint='slStringTranslate'; \n"
"  unsigned integer4 StringFind(const string src, const string tofind, unsigned4 instance ) : c,pure,fold,entrypoint='slStringFind'; \n"
"  unsigned integer4 StringUnboundedUnsafeFind(const string src, const string tofind) : c,pure,entrypoint='slStringFind2'; \n"
"  unsigned integer4 StringFindCount(const string src, const string tofind) : c,pure,fold,entrypoint='slStringFindCount'; \n"
"  unsigned integer4 EbcdicStringFind(const ebcdic string src, const ebcdic string tofind , unsigned4 instance ) : c,pure,fold,entrypoint='slStringFind'; \n"
"  unsigned integer4 EbcdicStringUnboundedUnsafeFind(const ebcdic string src, const ebcdic string tofind ) : c,pure,fold,entrypoint='slStringFind2'; \n"
"  string StringExtract(const string src, unsigned4 instance) : c,pure,fold,entrypoint='slStringExtract'; \n"
...
"  string8 GetDateYYYYMMDD() : c,once,pure,entrypoint='slGetDateYYYYMMDD2';\n"
"  varstring GetBuildInfo() : c,once,fold,entrypoint='slGetBuildInfo';\n"
"  string Data2String(const data src) : c,pure,fold,entrypoint='slData2String';\n"
"  data String2Data(const string src) : c,pure,fold,entrypoint='slString2Data';\n"
"  string StringToLowerCase(const string src) : c,pure,fold,entrypoint='slStringToLowerCase';\n"
"  string StringToUpperCase(const string src) : c,pure,fold,entrypoint='slStringToUpperCase';\n"
"  string StringToProperCase(const string src) : c,pure,fold,entrypoint='slStringToProperCase';\n"
"  string StringToCapitalCase(const string src) : c,pure,fold,entrypoint='slStringToCapitalCase';\n"
"  string StringToTitleCase(const string src) : c,pure,fold,entrypoint='slStringToTitleCase';\n"
"  integer4 StringCompareIgnoreCase(const string src1, const string src2) : c,pure,fold,entrypoint='slStringCompareIgnoreCase';\n"
"  string StringReverse(const string src) : c,pure,fold,entrypoint='slStringReverse';\n"
"  string StringFindReplace(const string src, const string stok, const string rtok) : c,pure,fold,entrypoint='slStringFindReplace';\n"
"  string StringCleanSpaces(const string src) : c,pure,fold,entrypoint='slStringCleanSpaces'; \n"
"  boolean StringWildMatch(const string src, const string _pattern, boolean _noCase) : c,pure,fold,entrypoint='slStringWildMatch'; \n"
"  boolean StringWildExactMatch(const string src, const string _pattern, boolean _noCase) : c,pure,fold,entrypoint='slStringWildExactMatch'; \n"
"  boolean StringContains(const string src, const string _pattern, boolean _noCase) : c,pure,fold,entrypoint='slStringContains'; \n"
"  string StringExtractMultiple(const string src, unsigned8 mask) : c,pure,fold,entrypoint='slStringExtractMultiple'; \n"
"  unsigned integer4 EditDistance(const string l, const string r) : c,pure,fold,entrypoint='slEditDistanceV2'; \n"
"  boolean EditDistanceWithinRadius(const string l, const string r, unsigned4 radius) : c,pure,fold,entrypoint='slEditDistanceWithinRadiusV2'; \n"
"  unsigned integer4 EditDistanceV2(const string l, const string r) : c,pure,fold,entrypoint='slEditDistanceV2'; \n"
"  boolean EditDistanceWithinRadiusV2(const string l, const string r, unsigned4 radius) : c,pure,fold,entrypoint='slEditDistanceWithinRadiusV2'; \n"
"  string StringGetNthWord(const string src, unsigned4 n) : c,pure,fold,entrypoint='slStringGetNthWord'; \n"
"  string StringExcludeLastWord(const string src) : c,pure,fold,entrypoint='slStringExcludeLastWord'; \n"
"  string StringExcludeNthWord(const string src, unsigned4 n) : c,pure,fold,entrypoint='slStringExcludeNthWord'; \n"
"  unsigned4 StringWordCount(const string src) : c,pure,fold,entrypoint='slStringWordCount'; \n"
"  unsigned4 CountWords(const string src, const string _separator, BOOLEAN allow_blanks) : c,pure,fold,entrypoint='slCountWords'; \n"
"  SET OF STRING SplitWords(const string src, const string _separator, BOOLEAN allow_blanks) : c,pure,fold,entrypoint='slSplitWords'; \n"
"  STRING CombineWords(set of string src, const string _separator) : c,pure,fold,entrypoint='slCombineWords'; \n"
"  UNSIGNED4 StringToDate(const string src, const varstring format) : c,pure,fold,entrypoint='slStringToDate'; \n"
"  UNSIGNED4 StringToTimeOfDay(const string src, const varstring format) : c,pure,fold,entrypoint='slStringToTimeOfDay'; \n"
"  UNSIGNED4 MatchDate(const string src, set of varstring formats) : c,pure,fold,entrypoint='slMatchDate'; \n"
"  UNSIGNED4 MatchTimeOfDay(const string src, set of varstring formats) : c,pure,fold,entrypoint='slMatchTimeOfDay'; \n"
"  STRING FormatDate(UNSIGNED4 date, const varstring format) : c,pure,fold,entrypoint='slFormatDate'; \n"
"  STRING StringRepeat(const string src, unsigned4 n) : c,pure,fold,entrypoint='slStringRepeat'; \n"
"END;";
