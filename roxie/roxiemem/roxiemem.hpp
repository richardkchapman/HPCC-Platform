...
protected:
    ...
    virtual void noteReleased(unsigned count, const byte * const * rowset) = 0;
...
public:
    ...
    static void releaseRowset(unsigned count, const byte * const * rowset);
...
private:
    ...
    virtual void noteReleased(unsigned count, const byte * const * rowset) override;
