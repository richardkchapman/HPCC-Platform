...
ECLRTL_API void rtlSubstituteEmbeddedScript(size32_t __lenResult, const char * &__result, size32_t scriptChars, const char *script, size32_t outFieldsChars, const char *outFields, size32_t searchChars, const char *search);
