...
output(C.sqHousePersonBookDs, { addr, summary1.numBooks, summary1.maxRating });
output(C.sqHousePersonBookDs, { addr, summary2.numBooks, summary2.aveRating, summary2.maxRating });
...
output(C.sqHousePersonBookDs, { addr, xsummary1.numBooks, xsummary1.maxRating });
output(C.sqHousePersonBookDs, { addr, xsummary2.numBooks, xsummary2.aveRating, xsummary2.maxRating });
...
output(C.sqHousePersonBookDs, { addr, xxsummary1.numBooks, xxsummary1.maxRating });
output(C.sqHousePersonBookDs, { addr, xxsummary2.numBooks, xxsummary2.aveRating, xxsummary2.maxRating });
