...
jlib_decl IPropertyTree * loadConfiguration(const char * configDir, const char * configFile, const char * componentTag, const char * legacyFile, const char * envPrefix, const char * *argv, IPropertyTree * (mapper)(IPropertyTree *));
