...
interface IThorResult : extends IInterface
{
    ...
    virtual void getLinkedResult(unsigned & count, const byte * const * & ret) = 0;
...
//  virtual void getLinkedResult(unsigned & count, const byte * const * & ret, unsigned id);
...
protected:
    ...
    public:
        ...
        virtual void getLinkedResult(unsigned & count, const byte * const * & ret) override { throw MakeStringException(0, "Graph Result %d accessed before it is created", id); }
